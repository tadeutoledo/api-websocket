...
socket.on("admin_list_all_users", (connections) => {
  ...
  console.log(`admin list ` + connections.length);
...
function call(id) {
  ...
  document.getElementById(`admin_${connection.user_id}`)?.remove();
  ...
  socket.emit('admin_start_chat', (params));
...
socket.on("client_send_to_admin", (params) => {
  ...
  const { text, email, user_id, created_at } = params;
